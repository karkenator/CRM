    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-sm font-semibold text-gray-900 mb-2">Campaign Configuration</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div>
              <label className="text-xs text-gray-600">Target CPA</label>
              <input
                type="number"
                step="0.01"
                value={targetCPA}
            ...
            <div>
              <label className="text-xs text-gray-600">Account Avg CPA</label>
              <input
                type="text"
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full px-3 py-1 text-sm font-medium text-white bg-brand hover:bg-brand/90 rounded disabled:opacity-50"
              >
      ...
      {actionSuccess && (
        <div className="p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg flex items-center justify-between">
          ...
          <button onClick={() => setActionSuccess(null)} className="text-green-700 hover:text-green-900">✕</button>
        </div>
      )}
      {actionError && (
        <div className="p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg flex items-center justify-between">
          <span>⚠ {actionError}</span>
          <button onClick={() => setActionError(null)} className="text-red-700 hover:text-red-900">✕</button>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            {recommendation.detected_value !== undefined && (
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-gray-100 rounded">
                  <div className="text-xs text-gray-600">Detected Value</div>
                ...
                {recommendation.benchmark_value !== undefined && (
                  <div className="p-3 bg-gray-100 rounded">
                    <div className="text-xs text-gray-600">Benchmark Value</div>
                    <div className="text-lg font-bold text-gray-900">
            ...
            <div className="p-3 bg-gray-100 rounded">
              <div className="text-xs text-gray-600 mb-1">Affected Entity</div>
